      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Icon(icon, color: AppColors.lightPrimary.withValues(alpha: 0.85), size: 22),
              Text(change, style: theme.textTheme.labelSmall?.copyWith(color: AppColors.lightSecondary, fontWeight: FontWeight.w500)),
            ],
          ),
          12.h,
